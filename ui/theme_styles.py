...
def flat_layout_css(theme: str) -> str:
    ...
    dark = theme == "dark"
    hdr_btn_border = "#334155" if dark else "#475569"
...
[data-testid="stSidebar"] .stButton > button:not([kind="primary"]) {{
    ...
    background: {"#1e293b" if dark else "#0f172a"} !important;
...
def header_toolbar_btn_css(theme: str) -> str:
    ...
    return f"""
<style>
/* Topbar container: thanh phẳng trên cùng, chỉ viền dưới */
[data-testid="stMain"] [class*="st-key"][class*="hdr_toolbar"] {{
    background: transparent !important;
    border: none !important;
...
[data-testid="stMain"] [class*="st-key"][class*="hdr_toolbar"] [data-testid="stHorizontalBlock"] {{
...
def streamlit_css(theme: str) -> str:
    ...
    sb_bg = "#0f172a" if dark else "#1e293b"
    sb_border = "#334155" if dark else "#2d3748"
    sb_label = "#94a3b8"
    sb_title = "#f8fafc"
    ...
    clause_bg = "#020617" if dark else "#0f172a"
    clause_text = "#f8fafc"
    clause_ph = "#64748b"
...
/* Nút thu gọn/mở sidebar luôn sáng (trắng) */
